...
::: r-hstack
::: {style="text-align: center;"}
::: {data-id="box1" style="background: #E96A81; width: 200px; height: 200px; margin: 25px;"}
:::
...
::: {style="text-align: center;"}
::: {data-id="box3" style="background: #92C46D; width: 200px; height: 200px; margin: 25px;"}
:::
...
## Design foundation 1: GAISE {.small}
...
2.  Integrate real data with a context and purpose.
3.  Foster active learning.
4.  Use technology to explore concepts and analyse data.
5.  Use assessments to improve and evaluate student learning.
...
::: question
Discuss in pairs of three and then as a large group.
...
Review and render the documnt, then fill in the blanks.
:::
