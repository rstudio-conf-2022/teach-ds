...
-   Local:
    ...
    -   Access the source file for the tutorial on GitHub: [https://github.com/rstudio-conf-2022/teach-ds-learnr](https://github.com/rstudio-conf-2022/teach-ds-learnr)
...
The [gradethis](https://pkgs.rstudio.com/gradethis/) package makes it feasible to check coding exercises in a learnr tutorial.
...
::: question
We have completed Day 01!
Please answer the following using your sticky notes:
