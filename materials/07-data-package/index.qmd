...
4.  Create a documentation file with `usethis::use_r("weather")`.
    -   Go to [https://r-pkgs.org/data.html#documenting-data to copy-paste](https://r-pkgs.org/data.html#documenting-data to copy-paste)a template.
...
::: share
{{< fa user-group >}} Work with your neighbor throughout this process.
You might also choose to pair program, where only one of you write code and the other navigates.
:::
